...
# [START logging_write_log_entry]
def list_processes(logger_name):
    """Writes the list of processes by calling "ps aux" in a dummy json and sends it to the Cloud Logger. """
    logging_client = logging.Client()
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'logger_name', help='Logger name', default='iszekely_logger')
    ...
    subparsers.add_parser('processes', help=list_processes.__doc__)
